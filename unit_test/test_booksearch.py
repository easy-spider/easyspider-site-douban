...
from douban.spiders.booksearch import BooksearchSpider
...
class TestSpiderBookSearch(TestCase):
    spider = BooksearchSpider(keyword="刘慈欣", page=1)
    ...
    def test_parse_test_result(self):
        true_response = online_response_from_url(
            "https://search.douban.com/book/subject_search?search_text=%E5%88%98%E6%85%88%E6%AC%A3&cat=1001",
        )
    ...
    def test_parse_search_result(self):
        true_url = "https://search.douban.com/book/subject_search?search_text=%E5%88%98%E6%85%88%E6%AC%A3&cat=1001"
