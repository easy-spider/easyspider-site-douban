...
class TestMoviesearchSpider(TestCase):
    ...
    def test_parse_test_result(self):
        true_response = online_response_from_url(
            "https://search.douban.com/movie/subject_search?search_text=%E8%AF%BA%E5%85%B0&cat=1002",
        )
    ...
    def test_parse_search_result(self):
        true_url = "https://search.douban.com/movie/subject_search?search_text=%E8%AF%BA%E5%85%B0&cat=1002"
